            ...
            {open && (
              <div className="absolute right-0 mt-3 w-72 bg-white border rounded-lg shadow-lg p-4">
                ...
                <div className="text-sm text-gray-700 space-y-1">
                  <p>
                    <span className="font-medium"></span> {userDetails.username}
                  </p>
                  <p>
                    <span className="font-medium"></span> {userDetails.phonenumber}
                  </p>
                  <p>
                    <span className="font-medium"></span> {userDetails.email} 
                  </p>
                </div>
                ...
                <Link >
                  <div className="w-full bg-yellow-400 hover:bg-yellow-500 py-2 rounded-md font-medium text-center cursor-pointer">
                    Edit profile
                  </div>
                </Link>
