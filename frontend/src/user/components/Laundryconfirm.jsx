...
const handleOrder = async () => {
  ...
  try {
    const result = await laundryorderAPI(orderData)
    console.log(result.data)
    alert("Laundry Order Booked Successfully")
  } catch (error) {
    console.log(error)
    alert("Order failed")
  }
      ...
      <section className="max-w-4xl mx-auto px-6 py-10">
       ...
       <div>
        ...
        <div className="bg-white shadow rounded-2xl p-6 mb-6">
          ...
          <p><strong>No of Clothes:</strong> {state?.noofclothes}</p>
          <p><strong>Fabric Type:</strong> {state.type}</p>
