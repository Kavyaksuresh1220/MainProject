...
import { myConfirmedOrdersAPI, myPickedOrdersAPI, mySalaryReportAPI } from '../../services/wasteManagementAPIs';
import { useEffect } from 'react';

function Wastemanagementstaff() {
      ...
      const getConfirmedOrders = async () => {
        ...
        const getPickedOrders = async () => {
          try {
            ...
            setPickedCount(response.data.total); // number of confirmed orders
          } catch (error) {
            console.error(error);
          }
        };
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
          ...
          {/* Pending */}
          <Link to={'/wastemanagement-staff-pending'}>
          ...
          <Link to="/wastemanagement-staff-confirmed">
            <div className="bg-white p-6 rounded-2xl shadow flex flex-col justify-center">
          ...
          {/* picked */}
          <Link to={'/wastemanagement-staff-picked'}>
          <div className="bg-white p-6 rounded-2xl shadow flex flex-col justify-center">
...
export default Wastemanagementstaff
