...
import { myCompletedOrdersAPI, updateToDeliveredAPI } from '../../services/allAPIS'

function Laundrycompleted() {
        ...
        const getCompletedorder = async () => {
            ...
            const delivered = async () => {
                try {
                  ...
                  await updateToDeliveredAPI(details._id, staffName)
                  console.log(details);
                  alert("Delivered")
                  ...
                  console.error("Failed to picked order", error)
                }
              }
  return (
    <>
...
export default Laundrycompleted
